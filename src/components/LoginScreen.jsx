...
export default function LoginScreen(props){
  ...
  return React.createElement('div',{style:{minHeight:'100vh',background:C.gradMain,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'2rem',gap:'1.5rem',fontFamily:F}},
    React.createElement('div',{style:{textAlign:'center',marginBottom:'1rem'}},
      React.createElement('div',{style:{display:'flex',justifyContent:'center',marginBottom:'0.9rem'}},React.createElement('div',{style:{width:'66px',height:'66px',borderRadius:'18px',background:'rgba(255,255,255,0.15)',border:'1px solid rgba(255,255,255,0.3)',display:'flex',alignItems:'center',justifyContent:'center'}},React.createElement(Wallet,{size:32,strokeWidth:2,color:C.white}))),
    ...
    props.denied
      ?React.createElement('div',{style:{background:'rgba(255,255,255,0.15)',borderRadius:'1rem',padding:'1rem 1.5rem',textAlign:'center',maxWidth:'280px'}},
          React.createElement('div',{style:{display:'flex',justifyContent:'center',marginBottom:'0.5rem'}},React.createElement(Ban,{size:26,strokeWidth:2,color:C.white})),
